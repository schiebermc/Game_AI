...
def instructions(window, automatic_solve_invoked=False):
    ...
    if automatic_solve_invoked:
        text1 = FONT1.render("AUTOMATIC SOLVE INVOKED, THINKING OF SOLUTION . . .", 1, (0, 0, 0)) 
        window.blit(text1, (10, HEIGHT + 10))         
    else: 
        text1 = FONT1.render("USE THE ARROW KEYS TO SLIDE THE GREY BLOCK", 1, (0, 0, 0)) 
        text2 = FONT1.render("PRESS 'a' TO INVOKE AN AUTOMATIC SOLVE", 1, (0, 0, 0)) 
        window.blit(text1, (10, HEIGHT + 10))         
        window.blit(text2, (10, HEIGHT + 50))         


def solved_instructions(window, step, total):
    pygame.draw.rect(window, WHITE, (0, HEIGHT, WIDTH, INSTRUCTIONS_HEIGHT))
    
    text1 = FONT1.render("AUTOMATIC SOLVE INVOKED, THINKING OF SOLUTION . . .", 1, (0, 0, 0)) 
    text2 = FONT1.render("DONE! PERFORMING MOVE {} OF {}".format(step, total), 1, (0, 0, 0)) 
    window.blit(text1, (10, HEIGHT + 10))         
    window.blit(text2, (10, HEIGHT + 50))         
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_DOWN:
                    ...
                    print("Solution found after visiting {} nodes".format(num_visited))                   
                    ...
                    for ind, move in enumerate(moves):
                        ...
                        board.draw(WINDOW)
                        solved_instructions(WINDOW, ind, len(moves))
                        pygame.display.update()
                        time.sleep(0.25)
                else:
                    print(event.type)
